...
GLfloat ambientColor0[] = { 0.0, 0.5, 0.8, 0.0 };//Глобальный свет(свет отражения от объектов) 
GLfloat diffuseColor0[] = { 0.1, 1.2, 0.5, 1.6 };//Свет в сферу(освещение сферы)
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("Нестеров_Александр_61гр.");
